  ...
  return [
    ...
    h('div.card', null,
      ...
      h('p.muted.small', null,
        'Поездка хранится только в этом браузере. На другом устройстве, даже по тому же '
        + 'адресу, будет своя отдельная поездка — сервер ваших трат не видит. Чтобы передать '
        + 'учёт, выгрузите копию и восстановите её там. Копию стоит делать в конце каждого дня.'),
      h('div.grid2', null,
        h('button.btn', {
          type: 'button',
